...
const Promotions: React.FC = () => {
  ...
  const columns = [
    ...
    { title: 'Giá trị giảm gía', dataIndex: 'discount_value', key: 'discount_value' },
    { title: 'Số lần sử dụng', dataIndex: 'usage_limit', key: 'usage_limit' },
    {
      title: 'Loại cấp bậc', dataIndex: 'tier_id', key: 'tier_id', render: (tierId: number) => {
    ...
    {
      title: 'Actions', key: 'actions', render: (record: Promotion) => (
        <>
  ...
  return (
    <div>
      <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 17 }}>
        <Select placeholder="Filter by Discount Value" allowClear
          style={{ width: 200 }}
        ...
        <Input placeholder="Search by code " prefix={<SearchOutlined />} value={searchText}
      ...
      >
        <Form
          form={form}
          initialValues={{
            code: '', discount_type: '', discount_value: 0, usage_limit: 0, start_date: '', end_date: '', is_active: false,
          }}
        ...
        >
            ...
            rules={[
              ...
              ({ getFieldValue }) => ({
                validator(_, value) {
                  ...
                  return Promise.reject('Discount value must be a non-negative number');
                },
              }),
            ]}
          >
            ...
            rules={[
              ...
              ({ getFieldValue }) => ({
                validator(_, value) {
                  ...
                  return Promise.reject('Usage limit must be a non-negative number');
                },
              }),
            ]}
          >
          ...
          <Form.Item name="tier_id" label="Tier" rules={[{ required: true, message: 'Please select a tier' }]}>
            <Select>
              {tiers.map((tier) => (
