...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const addWishB2Buttons = document.querySelectorAll(
    ".js-addwish-b2, .js-addwish-detail"
  );
  ...
  wishB2Buttons.forEach((button) => {
    const nameProduct = button
      .closest(".parent-selector")
      .querySelector(".js-name-b2").innerHTML; // Thay .parent-selector bằng selector cha thực tế
  ...
  wishDetailButtons.forEach((button) => {
    const nameProduct = button
      .closest(".parent-selector")
      .querySelector(".js-name-detail").innerHTML; // Thay .parent-selector bằng selector cha thực tế
